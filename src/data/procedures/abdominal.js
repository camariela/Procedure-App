...
export default defineProcedures('abdominal', [
  ...
  },
  {
    ...
    steps: [
      { text: 'Intubate first. Every time.', caution: 'This procedure in an unprotected airway is how these patients aspirate and die.' },
      { text: 'Test both balloons under water, check for leaks, then deflate them completely.' },
      { text: 'Label every port with tape and mark the intended depth — roughly 50 cm at the teeth — before anything goes in.' },
      { text: 'Insert orally with a laryngoscope and Magill forceps to 50 cm. The nasal route is harder and risks necrosis.' },
      { text: 'Confirm the gastric balloon is below the diaphragm before inflating anything.', caution: 'Inflating a gastric balloon in the oesophagus ruptures the oesophagus. Radiograph or ultrasound if there is any doubt — and there usually is.' },
      { text: 'Inflate the gastric balloon in 50-100 mL steps to 250-300 mL, stopping immediately for pain or resistance.' },
      { text: 'Clamp the gastric port, then withdraw the tube until you feel firm resistance at the gastro-oesophageal junction.' },
      { text: 'Apply 0.5-1 kg of traction over a pulley at the head of the bed, and write the depth at the teeth on the board.' },
      { text: 'Reassess through the gastric aspiration port. Most variceal bleeding stops with the gastric balloon alone.' },
      { text: 'Only if bleeding continues, inflate the oesophageal balloon to 30-45 mmHg by manometer.', caution: 'Never above 45 mmHg. Release it for 5-10 minutes every 6-8 hours — mucosal necrosis begins within hours.' },
      { text: 'Arrange definitive therapy now and deflate within 24 hours, oesophageal balloon first, always.' },
    ],
    pearls: [
